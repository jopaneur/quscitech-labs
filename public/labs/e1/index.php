...
$return = $_SERVER['REQUEST_URI'] ?? ($prefix . '/labs/e1/');
...
<head>
  <meta charset="utf-8">
  <title>E.1 — Beginner Labs (No-Code)</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
</head>
<body style="font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;margin:20px;">
  <h1>E.1 — Beginner Labs (No-Code)</h1>
  <p><strong>Access:</strong> Unlocked (book-buyer)</p>

  <p>
    This is the E.1 track landing page. Replace this body with your actual E.1 track UI (cards, badges, notebook links, etc.).
  </p>
