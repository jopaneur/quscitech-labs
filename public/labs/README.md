...
|-----------|--------------|
| `resources/notebooks/` | Demo + exercise notebooks |
| `resources/html/` | Published static HTML page |
| `resources/assets/` | Supporting images, docs, and datasets |
| `resources/tests/` | CI smoke test confirmation files |

## Deployment
This lab is published via **public-deploy.yml** under:
/home/quscitech/public_html/instructors/QST-INST-2025/resources/labs/Intermediate_Labs/qais-angle-encoding-statevectors-lab/
